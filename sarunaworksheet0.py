# -*- coding: utf-8 -*-
"""Sarunaworksheet0.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11ogF1tVsOd8aKK4ZaKvIlS-Id2kAv1nn
...
Write a function longest_common_subsequence(s1, s2) that: • Uses DP to find the length of the LCS of two strings s1 and s2.
Test with strings like "abcde" and "ace"; the LCS length should be 3 ("ace").
"""
...
Write a function knapsack(weights, values, capacity) that: • Uses DP to determine the maximum value that can be achieved within the given weight capacity.

Test with weights [1, 3, 4, 5], values [1, 4, 5, 7], and capacity 7. The re- sult should be 9.
"""
